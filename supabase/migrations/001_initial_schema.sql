...
CREATE TABLE businesses (
    ...
    business_type VARCHAR(100), -- sole_proprietorship, partnership, llp, pvt_ltd, etc.
    gst_number VARCHAR(15) UNIQUE,
    pan_number VARCHAR(10),
    cin_number VARCHAR(21), -- Company Identification Number
    ...
    website VARCHAR(255),
    logo_url TEXT,
    bank_details JSONB, -- Store bank account details as JSON
...
CREATE TABLE items (
    ...
    description TEXT,
    unit VARCHAR(50) DEFAULT 'piece', -- piece, kg, liter, hour, etc.
    hsn_code VARCHAR(10), -- Harmonized System of Nomenclature
    sac_code VARCHAR(10), -- Service Accounting Code
    ...
    igst_rate DECIMAL(5,2) DEFAULT 0.00, -- Integrated GST
    cess_rate DECIMAL(5,2) DEFAULT 0.00, -- Cess
...
CREATE TABLE invoices (
    ...
    -- Ensure unique invoice numbers per business
...
CREATE TABLE payments (
    ...
    -- Ensure unique payment numbers per invoice
